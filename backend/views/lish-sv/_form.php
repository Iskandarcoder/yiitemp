...
<div class="lish-sv-form">
    ...
    <?= $form->field($model, 'convict_date')->textInput() ?>

    <?= $form->field($model, 'convict_country_id')->textInput() ?>

    <?= $form->field($model, 'convict_place')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'punishment_place')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'release_date')->textInput() ?>

    <?= $form->field($model, 'release_add_info')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'doc_add_info')->textInput(['maxlength' => true]) ?>
