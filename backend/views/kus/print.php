...
<a class="btn btn-lg green hidden-print margin-bottom-5" style="float: right;" href="<?= Url::to(['kus/index'])?>">
...
<div style="margin: auto;width: 750px;">
	...
	<table  border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<th style="text-align: right;padding: 5px;"><?php echo '<img style="width:125; height:160px; overflow:hidden" src="data:image/jpeg;base64,'.base64_encode($model->photo).'"/>';?>
			</th>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="border: 1px solid black;  padding: 2px;padding: 5px;"> <?=$model->surname_latin;?> <?=$model->name_latin;?> <?=$model->patronym_latin;?></td>
		</tr>
		<tr>
			...
			<td style="border: 1px solid black;  padding: 2px;"><?=$model->birth_date;?></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="border: 1px solid black;  padding: 2px; text-align: center;">7</td><td style="border: 1px solid black;  padding: 2px;">O'zbekiston Respublikasida<br>oxirgi yashagan manzili</td>
