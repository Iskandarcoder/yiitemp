...
<div class="dead-form">
    ...
    <?= $form->field($model, 'death_country_id')->textInput() ?>

    <?= $form->field($model, 'death_foreign_place')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'dead_missing_type')->textInput() ?>

    <?= $form->field($model, 'death_date')->textInput() ?>

    <?= $form->field($model, 'death_cause')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'death_certificate_seria')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'death_certificate_number')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'death_certificate_date')->textInput() ?>

    <?= $form->field($model, 'death_certificate_give_org')->textInput(['maxlength' => true]) ?>
