...
/* @var $model backend\models\SertSearch */
...
<div class="sert-search">
    ...
    <?php // echo $form->field($model, 'birth_street_id') ?>

    <?php // echo $form->field($model, 'birth_block') ?>

    <?php // echo $form->field($model, 'birth_house') ?>

    <?php // echo $form->field($model, 'birth_flat') ?>
    ...
    <?php // echo $form->field($model, 'arrival_reason_id') ?>
    ...
    <?php // echo $form->field($model, 'validity_date_certificate') ?>
    ...
    <?php // echo $form->field($model, 'status_mvd') ?>

    <?php // echo $form->field($model, 'date_mvd') ?>

    <?php // echo $form->field($model, 'comment') ?>

    <?php // echo $form->field($model, 'print_status') ?>

    <?php // echo $form->field($model, 'annul_status') ?>
    ...
    <?php // echo $form->field($model, 'Sharif') ?>

    <?php // echo $form->field($model, 'Tug_Sana') ?>

    <?php // echo $form->field($model, 'surname_eng') ?>
