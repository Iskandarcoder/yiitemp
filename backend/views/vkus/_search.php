...
/* @var $model backend\models\VkusSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="vkus-search">
    ...
    <?php // echo $form->field($model, 'wed_name') ?>

    <?php // echo $form->field($model, 'education') ?>

    <?php // echo $form->field($model, 'education_date') ?>

    <?php // echo $form->field($model, 'which_school') ?>
