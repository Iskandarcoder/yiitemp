...
/**
 * LishSvSearch represents the model behind the search form about `backend\models\LishSv`.
 */
class LishSvSearch extends LishSv
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'pinpp', 'surname_cyrillic', 'name_cyrillic', 'patronym_cyrillic', 'surname_latin', 'name_latin', 'patronym_latin', 'birth_date', 'birth_place_latin', 'doc_seria', 'doc_number', 'date_begin_document', 'date_end_document', 'document_div_place', 'living_block', 'living_house', 'living_flat', 'arrival_date', 'convict_date', 'convict_place', 'offense_article', 'punishment_place', 'release_date', 'release_add_info', 'doc_add_info', 'creation_date', 'living_uzb_place', 'add_info', 'Send_status'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'convict_date' => $this->convict_date,
            'convict_country_id' => $this->convict_country_id,
        ...
        $query->andFilterWhere(['like', 'id', $this->id])
            ...
            ->andFilterWhere(['like', 'convict_place', $this->convict_place])
            ->andFilterWhere(['like', 'offense_article', $this->offense_article])
            ->andFilterWhere(['like', 'punishment_place', $this->punishment_place])
            ->andFilterWhere(['like', 'release_add_info', $this->release_add_info])
            ->andFilterWhere(['like', 'doc_add_info', $this->doc_add_info])
