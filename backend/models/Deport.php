...
/**
 * This is the model class for table "deport".
 *
 * @property string $id
 ...
 * @property string $deport_date
 * @property string $deport_route
 * @property string $creation_date
 * @property string $living_uzb_place
 * @property string $add_info
 * @property string $Send_status
 */
class Deport extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'division_id', 'surname_latin', 'name_latin', 'patronym_latin', 'birth_date', 'sex_id', 'nationality_id', 'birth_country_id', 'document_type_id', 'date_begin_document', 'living_country_id', 'living_region_id', 'living_district_id', 'arrival_country_id', 'living_foreign_place', 'deport_date', 'creation_date'], 'required'],
            ...
            [['date_begin_document', 'date_end_document', 'deport_date', 'creation_date'], 'safe'],
            [['deport_route'], 'string'],
            [['id'], 'string', 'max' => 32],
            [['pinpp'], 'string', 'max' => 14],
            ...
            [['birth_place_latin', 'document_div_place', 'living_foreign_place', 'offense_article', 'living_uzb_place'], 'string', 'max' => 250],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'deport_date' => Yii::t('app', 'Deport Date'),
            'deport_route' => Yii::t('app', 'Deport Route'),
