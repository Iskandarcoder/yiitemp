...
/**
 * PnPravoSearch represents the model behind the search form about `backend\models\PnPravo`.
 */
class PnPravoSearch extends PnPravo
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'human_traffic' => $this->human_traffic,
            'fabula_id' => $this->fabula_id,
