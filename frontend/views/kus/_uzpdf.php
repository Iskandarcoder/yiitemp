	...
	<table width="800" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<th  style="text-align: center;font-size: 16px;" >
				Xorijda doimiy yashovchi<br>O`zbekiston Respublikasi fuqarolarining<br><b>RO`YXATGA OLISH VARAG`I</b>
			</th>
		...
		<tr>
			...
			<td style="border: 1px solid black; padding:5px;"><?=$model->adregion->sp_name_uz?>, <?=$model->addistrict->sp_name_uz?>,  <?=$model->adstreet->sp_name_uz?>, <?=$model->living_block;?>/<?=$model->living_house;?>/<?=$model->living_flat;?></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="border: 1px solid black; padding:5px; text-align: center;">13</td><td style="border: 1px solid black; padding:5px;">Birga kelgan shaxslar</td>
			<td style="border: 1px solid black; padding:5px;"></td>
		</tr>
		<tr>
			<td style="border: 1px solid black; padding:5px; text-align: center;">14</td><td style="border: 1px solid black; padding:5px;">Pasport almashganlik tugrisidagi <br>	Hujjat bergan tashkilot<br>	pasport seriasi, raqami,<br>	amal qilish muddati</td>
			<td style="border: 1px solid black; padding:5px;"></td>
		</tr>
		<tr>
			<td style="border: 1px solid black; padding:5px; text-align: center;">15</td><td style="border: 1px solid black; padding:5px;">О’zbekistonga tashrif buyurganlik to'grisidagi  belgilar</td>
			<td style="border: 1px solid black; padding:5px;"></td>
		</tr>
		<tr>
