...
class VkusSearch extends Vkus
{
    ...
    {
        return [
            [['id', 'reg_num', 'pinpp', 'surname_cyrillic', 'name_cyrillic', 'patronym_cyrillic', 'surname_latin', 'name_latin', 'patronym_latin', 'birth_date', 'photo', 'birth_place_latin', 'doc_seria', 'doc_number', 'date_begin_document', 'date_endocument', 'document_div_place', 'living_block', 'living_house', 'living_flat', 'living_place_latin', 'living_foreign_place', 'begin_date', 'arrival_date', 'work_place', 'doc_adinfo', 'creation_date', 'foundation_cons_acc', 'living_uzb_place', 'senstatus', 'endate', 'status', 'adinfo'], 'safe'],
            [['division_id', 'sex_id', 'nationality_id', 'marital_status_id', 'birth_country_id', 'birth_region_id', 'birth_district_id', 'birth_place_id', 'document_type_id', 'document_div_id', 'living_country_id', 'living_region_id', 'living_district_id', 'living_place_id', 'living_street_id', 'living_foreign_country_id', 'other_citizenship_id', 'reason_id'], 'integer'],
        ];
    }
